...
export const faqData: FaqItem[] = [
  {
    ...
    a: [
      "Ceny ustalamy indywidualnie — ostateczna kwota zależy od rozmiaru, stylu i czasu pracy. Małe dziarki fineline kosztują inaczej niż rozbudowany blackwork. Napisz do nas lub do wybranej artystki — wycena jest bezpłatna i niewiążąca. Rozpisaliśmy też szczegółowo, ",
      {
        text: "od czego zależy cena tatuażu",
  ...
  },
  {
    q: "Czy tatuaż boli?",
    a: [
      "Ból jest bardzo indywidualny — zależy od miejsca, Twojej wrażliwości i przygotowania. Większość osób opisuje to jako mrowienie albo „draśnięcie”. Pracujemy w komfortowym tempie i możesz poprosić o przerwę w każdej chwili. Więcej w poradniku: ",
      { text: "czy tatuaż boli", href: "/poradniki/czy-tatuaz-boli" },
      ".",
    ],
  },
  {
    ...
    a: [
      "Zjedz porządny posiłek i nawodnij się, unikaj alkoholu min. 24 h przed, a skórę w dniu wizyty zostaw czystą i nienatłuszczoną. Ubierz się tak, by artystka miała swobodny dostęp do tatuowanego miejsca. Pełną listę znajdziesz w poradniku ",
      {
  ...
  },
  {
    ...
    a: [
      "Świeży tatuaż myj delikatnie, nie mocz długo (zakaz basenu/sauny ~2 tyg.), nawilżaj cienko kremem poleconym przez artystkę i nie zdrapuj strupków. Dokładne instrukcje dostaniesz po sesji, a krok po kroku opisaliśmy je w poradniku ",
      { text: "jak dbać o tatuaż", href: "/poradniki/jak-dbac-o-tatuaz" },
      ".",
    ],
  },
  {
    ...
    a: [
      "Wierzchnia warstwa skóry zamyka się w ~2 tygodnie, pełne wygojenie w głębszych warstwach trwa do 2–3 miesięcy. Trzymając się instrukcji pielęgnacyjnych, tatuaż wygląda tak, jak powinien. Rozpisaliśmy ",
      { text: "gojenie etapami", href: "/poradniki/jak-dbac-o-tatuaz" },
      ".",
    ],
  },
  {
